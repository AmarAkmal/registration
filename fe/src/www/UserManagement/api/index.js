...
export default {
    list_user_profile : (params) => {
        ...
        return new Promise((resolve, reject) => {
            fetch(`${global.ipServer}user/list`, {
                method: 'POST',
                body: formData,
                headers: {
    ...
    add_user_profile : (params) => {
        ...
        return new Promise((resolve, reject) => {
            fetch(`${global.ipServer}user/add_user`, {
                method: 'POST',
                body: formData,
                headers: {
                    'x-access-token': localStorage.getItem("n29pa87zfm"),
    ...
    delete_user_profile : (params) => {

        const formData = new FormData()
        formData.append('ref', JSON.stringify(params))

        return new Promise((resolve, reject) => {
            fetch(`${global.ipServer}user/delete_user`, {
                method: 'POST',
                body: formData,
                headers: {
                    'x-access-token': localStorage.getItem("n29pa87zfm"),
    ...
    update_user_profile : (params) => {
        ...
        return new Promise((resolve, reject) => {
            fetch(`${global.ipServer}user/update_user`, {
                method: 'POST',
                body: formData,
                headers: {
                    'x-access-token': localStorage.getItem("n29pa87zfm"),
    ...
    get_username : () => {
        ...
        return new Promise((resolve, reject) => {
            fetch(`${global.ipServer}user/username`, {
                method: 'POST',
                headers: {
                    'x-access-token': localStorage.getItem("n29pa87zfm"),
                }
    ...
    get_email : () => {
        ...
        return new Promise((resolve, reject) => {
            fetch(`${global.ipServer}user/email`, {
                method: 'POST',
                headers: {
                    'x-access-token': localStorage.getItem("n29pa87zfm"),
                }
